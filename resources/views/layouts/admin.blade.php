...
<head>
    ...
    <title>@yield('title', 'ArtemVita Admin')</title>
...
<body class="bg-gray-100 text-gray-800 flex flex-col min-h-screen">
    ...
    <header class="bg-white text-black px-6 py-4 flex flex-wrap items-center justify-between border border-gray-300 shadow-md">
        ...
        <nav class="flex space-x-4 mb-2 sm:mb-0">
            ...
            <a href="/admin/products" class="text-gray-700 hover:text-blue-500 px-3 py-2 rounded-lg transition duration-300">Products</a>
            ...
            <a href="/admin/users" class="text-gray-700 hover:text-blue-500 px-3 py-2 rounded-lg transition duration-300">Users</a>
            <a href="/admin/product-requests" class="text-gray-700 hover:text-blue-500 px-3 py-2 rounded-lg transition duration-300">Product Requests</a>
        </nav>
